...
export default function Students() {
  ...
  useEffect(() => {
    fetchListStudentsQuery(true, null)
      .then(value => {
        setTable([...value]);
      })
      .catch(err => {
  ...
  const onStudentFilterSearch = async (
    ...
    fetchFilterListStudentsQuery(selectedIndex, fieldValue)
      .then(value => {
  ...
  const handleFetchListStudentsQuery = () => {
    fetchListStudentsQuery(false)
      .then(value => {
        ...
        <Card>
          ...
          <CardBody>
            ...
            <EnhancedTableRadio
              ...
              onGetMoreRows={handleFetchListStudentsQuery}
            />
          </CardBody>
        </Card>
      </GridItem>
